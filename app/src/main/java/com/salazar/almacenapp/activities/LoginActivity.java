...
import com.salazar.almacenapp.models.Login;
import com.salazar.almacenapp.models.Usuario;
...
//                        Toast.makeText(LoginActivity.this,"Bienvenido "+response.body().getNombres(), Toast.LENGTH_LONG).show();
